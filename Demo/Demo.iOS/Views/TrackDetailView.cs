...
namespace Demo.iOS
{
	[Register("TrackDetailView")]
	[MvxPanelPresentation(MvxPanelEnum.Center, MvxPanelHintType.ActivePanel, true)]
	public class TrackDetailView : BaseViewController<TrackDetailViewModel>
	{
		public override void ViewDidLoad()
		{
			...
			var set = this.CreateBindingSet<TrackDetailView, TrackDetailViewModel>();
		...
		{
			Title = ViewModel.TrackParam.Name;
